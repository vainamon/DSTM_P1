...
llvm-gcc -c -I"/home/zkaliaev/danilov/install/include" -I"/home/zkaliaev/danilov/install/include/ibv-conduit" -O4 --emit-llvm --gnu-tm -DGASNET_PAR -DGASNET_CONDUIT_IBV=1 bank_my.c -o bank.bc
mv bank.bc /home/zkaliaev/PROJECTS
