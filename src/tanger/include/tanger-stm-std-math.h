...
double log(double) __attribute__ ((tm_pure));
double sqrt(double) __attribute__ ((tm_pure));
double acos(double) __attribute__ ((tm_pure));
double cos(double) __attribute__ ((tm_pure));
float fcos(float) __attribute__ ((tm_pure));
double sin(double) __attribute__ ((tm_pure));
float fsin(float) __attribute__ ((tm_pure));
double fabs(double) __attribute__ ((tm_pure));
