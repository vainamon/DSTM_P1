...
#define FREGS2(ID, RETTYPE, ARG1, ARG2) \
    ...
    FREGS1(tanger_stm_malloc, voidptr, sizet);
    FREGS2(calloc, voidptr, sizet, sizet);
    FREGS2(tanger_stm_calloc, voidptr, sizet, sizet);
    FREGS2(realloc, voidptr, voidptr, sizet);
    FREGS2(tanger_stm_realloc, voidptr, voidptr, sizet);
    FREGS1(free, voidty, voidptr);
    FREGS1(tanger_stm_free, voidty, voidptr);

    // ITM interface
    registerFunction(itm_begin, true, "_ITM_beginTransaction", uint32, uint32,
            NULL);
