...
public:
    const static unsigned loadstore_funcs_count = 7;
protected:
    Interface* tif;
    Function** func_load;       // 8b, 16b, 16baligned, 32b, 32b aligned, 64b, 64b aligned
    Function** func_store;      // 8b, 16b, 16baligned, 32b, 32b aligned, 64b, 64b aligned
    Function* func_loadregionpre;
    Function* func_loadregionpost;
    Function* func_storeregionpre;
    Function* func_updateregionpre;
public:
    TransformLoadStore() :
